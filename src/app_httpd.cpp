...
{
    Serial.println("led handler called");
    bFlashLed = true;
...
{
    //Serial.println("joystick handler called");
    //bFlashLed = true;
    ...
    if (buf_len > 1)
    {
        ...
        {
            if (httpd_query_key_value(buf, "x", x_str, sizeof(x_str)) == ESP_OK &&
                httpd_query_key_value(buf, "y", y_str, sizeof(y_str)) == ESP_OK)
            {
            }
            else
            {
...
{
    Serial.println("index handler: 2640 file ");
    ...
    if (s->id.PID == OV3660_PID)
    {
        ...
        Serial.println("index handler: 3660 file ");
    }
